...
## Overview
Tasks are discrete, actionable items that can be executed individually or as part of workflows. These are designed to work with MCP servers for vibecoding workflows.
